    ...
    <div className="h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 flex items-center justify-center overflow-hidden">
      ...
      <div className="fixed top-4 right-4 z-50">
        <a 
          ...
          className="flex items-center bg-black/20 backdrop-blur-sm border border-white/20 rounded-full px-3 py-1.5 text-white/80 hover:text-white hover:bg-black/30 transition-all text-xs"
        >
          <img 
            src="./bolt.png" 
